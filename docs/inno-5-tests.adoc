= F[20] IPOD: Tests
J.-M. Bruel -- jbruel@gmail.com -- v1.0 {localdate}
:imagesdir: images
:sectids!:
:experimental:
:stylesdir: styles
...
:siteurl: https://jmbruel.github.io/InnopolisModernApplicationProduction/
...
Whatever development method you apply, tests are [red]#*the only way to ensure*#
that the delivered product [red]#*conforms to the client's requirements*#.
...
image::titanic.jpg[role=crux,credit="source: Internet!"]

ifdef::slides[==  Integration Tests]
image::no-integration-testing.jpg[width=80%,role=crux,credit="source: Internet!"]
...
icon:globe[]:: https://jmbruel.netlify.com
icon:github[]:: github.com/jmbruel
