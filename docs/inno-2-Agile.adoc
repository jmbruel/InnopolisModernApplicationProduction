...
:numbered:
:status:
:siteurl: https://jmbruel.github.io/teachingMaterials/
:bitlysiteurl: https://bit.ly/jmb-teaching
...
This course is dedicated to my lost friend 
...
image::Vcycle.png[width=50%, scaledwidth="90%"]
