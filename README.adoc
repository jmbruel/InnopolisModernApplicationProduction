...
. Introduction and organization `2021/03/23`
...
//- {website}/inno-3-Manifesto.html[HTML] / {website}/inno-3-Manifesto.deckjs.html[Slides] / https://www.dropbox.com/sh/g8w2izswx9pdp5j/AAAqJyqQNayIbjyWvYYVpp7ba?dl=0[Recording of Nov. 9th]
