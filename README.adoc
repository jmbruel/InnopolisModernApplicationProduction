...
- Traceability Project: https://github.com/jmbruel/MAP-S21-template
...
- Agile Manifesto: {website}/inno-3-Manifesto.html[HTML] / {website}/inno-3-Manifesto.deckjs.html[Slides]
